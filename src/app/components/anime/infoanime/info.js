...
export default function Info({ dataAnime, episodes }) {
  let [data] = useState({ characters: dataAnime.characters, related: dataAnime.related, episodes: episodes.episodes })
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        (dataAnime.rating) > rating ? 'text-orange-600' : 'text-gray-200',
                          ...
                          {data.characters.map((character) => (
                            ...
                            >
                              <h3 className="text-sm font-medium leading-5 flex items-center ">
                                {character.name}<p className='ml-5' >{character.role}</p>  <Image src={character.image} alt={character.name} width={70} height={70} className='object-cover ml-5' />
                              </h3>
                            </li>
                          ))}
                        </ul>
                        ...
                        <ul>
                          {data.related.map((item, index) => (
                            ...
                            >
                              ...
                              <Image src={item.poster} alt={item.title} width={80} height={80} />
